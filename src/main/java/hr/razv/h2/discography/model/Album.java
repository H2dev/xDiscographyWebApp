...
public class Album implements Serializable {
	...
	@DatabaseField(columnName = TRACKLIST_FIELD, canBeNull = true)
	private String tracklist;
	
	private List<String> tracklistJavaList;
	...
	public List<String> getTracklistJavaList() {
		return tracklistJavaList;
	}

	public void setTracklistJavaList(List<String> tracklistJavaList) {
		this.tracklistJavaList = tracklistJavaList;
	}
